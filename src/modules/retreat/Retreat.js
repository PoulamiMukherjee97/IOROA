...
import { pdfCreation } from '../../utils/Utiliy';
    ...
    return (<div className="container text-primary-color border-primary-color p-5 text-center mt-3">
        ...
        {Info.map(item => (
            <div className="mb-5">
                ...
                {item.pdf && <a href={pdfCreation(item.pdf)} download className="mt-2 text-decoration-none">
                    ...
                    <span className="px-2 text-primary-color">{item.pdfDesc}</span>
                </a>
                }
            </div>))}
    </div>)
